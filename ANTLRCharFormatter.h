...
#ifndef _ANTLRCharFormatter_h_
	#define _ANTLRCharFormatter_h_

@protocol ANTLRCharFormatter

-(NSString*)escapeCharacter:(unichar)_c
			 forCharLiteral:(BOOL)_flag;
-(NSString*)escapeString:(NSString*)_str;

-(NSString*)literalChar:(unichar)_c;
-(NSString*)literalString:(NSString*)_str;

@end

#endif //_ANTLRCharFormatter_h_
