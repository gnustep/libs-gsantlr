...
-(id)initWithNodes:(NSArray*)_nodes
{
  ...
  if ((self=[super init]))
	{
	  if (![_nodes isKindOfClass:[NSMutableArray class]])
		_nodes=[_nodes mutableCopy];
	  ASSIGN(nodes,(NSMutableArray*)_nodes);
	};
  LOGObjectFnStop();
  return self;
};
