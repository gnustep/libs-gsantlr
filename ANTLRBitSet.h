...
#ifndef _ANTLRBitSet_h_
	#define _ANTLRBitSet_h_

#include <Foundation/NSRange.h>

@class NSArray, NSEnumerator;

typedef unsigned int ANTLRBitSetStorage;

@protocol ANTLRBitSet <NSObject>
...
@interface ANTLRBitSet : NSObject <ANTLRBitSet,NSCopying,NSCoding>
{
@protected
...
extern NSString* stringValueForBitset(unsigned int _set, char _setC, char _unsetC,short _wide);

#endif //_ANTLRBitSet_h_
