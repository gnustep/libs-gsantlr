...
#include "gsantlr/ANTLRCommonAST.h"

@implementation ANTLRCommonAST
...
{
  return [self initWithTokenType:[_AST tokenType]
			   text:[_AST text]];
};
...
{
  return [self initWithTokenType:[_token tokenType]
			   text:[_token text]];
};
...
{
  ANTLRDefAST clone = [super copyWithZone:_zone];
  [clone setTokenType:ttype];
