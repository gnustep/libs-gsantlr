...
#ifndef _ANTLRNoViableAltException_h_
	#define _ANTLRNoViableAltException_h_

@class ANTLRToken;

@interface ANTLRNoViableAltException : ANTLRParserException
{
  ANTLRDefToken token;
  ANTLRDefAST AST;
};
...
#endif //_ANTLRNoViableAltException_h_
