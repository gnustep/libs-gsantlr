...
*/
#ifndef _ANTLRException_h_
	#define _ANTLRException_h_

#include <Foundation/NSException.h>

@interface ANTLRException : NSException
-(id)init;
@end

@interface ANTLRScannerException : ANTLRException
{
  int line;
  int column;
  int c;
...
@interface ANTLRParserException : ANTLRException
{
  int line;
  int column;
}
...
@interface ANTLRSemanticException : ANTLRParserException
@end

#endif //_ANTLRException_h_
